...
6. X / 社群人物區固定 3 格：優先檢查 @elonmusk、@realDonaldTrump、@saylor 第一手發言，但這三人只是候選，不是固定版位；只允許早報產出時點往前 24 小時內、且來源作者、status URL 與時間可驗證的貼文／公開發言。Chrome/X 的自動翻譯可僅作理解原帖的輔助，不能當作原帖文字或用來判定原帖語言；未實際看見原文時，只能忠實轉述內容，不可逐字引號引用或聲稱「日文／英文短句」。每卡至少要有可驗證的決策、產品／技術／交易／投資／政策行動，或具明確對象與結果的事件資訊；單字、感嘆詞、emoji、口號、雙關、迷因與無資訊活動預告都不具實質性，直接換帖或換人。台灣政治人物可檢查柯文哲、黃國昌或其本人/政黨/黨團官方 X 單篇 status，只有 24 小時內可驗證且具政策、國會或市場影響的發言才可放入社群人物區。X / 社群人物區嚴禁使用賴清德、總統府轉述或新聞稿式賴清德談話；若賴清德相關事件確實重要，只能放在台灣新聞卡，不占人物卡。X/Twitter 原文必須用單篇 status URL，並確認該 status 的實際發文時間在 24 小時內；不可用個人頁、搜尋頁、新聞轉述或舊貼文冒充 today。若候選人沒有 24 小時內可驗證發言，不要寫「未找到」提示文，改用 24 小時內話題排名 1–3 的知名人物實際發言補滿 3 格。
...
- 每張人物卡是否忠實對應 status 的作者、時間與內容？翻譯介面僅能輔助轉述，不得被稱作原文或拿來判斷語言。是否有單字、感嘆詞、emoji、口號、雙關、迷因或「未揭露／未交代」型空內容？任一是，換帖或換人。
