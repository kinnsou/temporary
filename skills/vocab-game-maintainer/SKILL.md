...
- **Streak leaderboard eligibility**: exclude visitor-grade rows where `streakCur === 1` and today's quiz count is 0 (also excludes streak 0). Older real streaks (`streakCur > 1`) remain listed even before today's quiz.
